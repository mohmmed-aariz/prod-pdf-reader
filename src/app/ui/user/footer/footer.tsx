...
export default async function Footer(){
  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <Link href="/agency" aria-label="Go home" title="Company" className="inline-flex items-center">
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <Link href="tel:7597163238" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">75971-63238</Link>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800">Email:</p>
        <Link href="mailto:mohmmed.ariz786@gmail.com" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">abc@gmail.com</Link >
      </div>
      {/* <div className="flex">
    ...
    <div>
      ...
      <p className="mt-4 text-sm text-gray-500">
        ...
        {/* Stay connected with us for expert-driven content tailored specifically for students.  */}
        Follow us for more insightful and educational updates!      </p>
    </div>
  </div>
  <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    ...
    <li>
        <Link href="/agency" className="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Agency</Link >
      </li>
      {/* <li>
